"""
Django settings for property_rewriter project.
...
SECRET_KEY = 'django-insecure-l7m6f34@xp^l$s)_2j6jd(3x9h$rd(*4h@q82sr1s@+mm%l&ba'
...
WSGI_APPLICATION = 'property_rewriter.wsgi.application'
